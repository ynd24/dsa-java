...
public class SpanningTree implements Comparable<SpanningTree> { // implements comparable interface for compareto
    private final List<Edge> edges; // all edges in this spanning tree
